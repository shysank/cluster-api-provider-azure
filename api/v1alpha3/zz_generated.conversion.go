...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*AzureClusterIdentitySpec)(nil), (*v1alpha4.AzureClusterIdentitySpec)(nil), func(a, b interface{}, scope conversion.Scope) error {
	...
	if err := s.AddGeneratedConversionFunc((*v1alpha4.AzureClusterIdentitySpec)(nil), (*AzureClusterIdentitySpec)(nil), func(a, b interface{}, scope conversion.Scope) error {
	...
	if err := s.AddGeneratedConversionFunc((*v1alpha4.AzureSharedGalleryImage)(nil), (*AzureSharedGalleryImage)(nil), func(a, b interface{}, scope conversion.Scope) error {
	...
	if err := s.AddGeneratedConversionFunc((*v1alpha4.LoadBalancerSpec)(nil), (*LoadBalancerSpec)(nil), func(a, b interface{}, scope conversion.Scope) error {
...
func autoConvert_v1alpha3_AzureClusterIdentityList_To_v1alpha4_AzureClusterIdentityList(in *AzureClusterIdentityList, out *v1alpha4.AzureClusterIdentityList, s conversion.Scope) error {
	...
	out.Items = *(*[]v1alpha4.AzureClusterIdentity)(unsafe.Pointer(&in.Items))
	return nil
}
...
func autoConvert_v1alpha4_AzureClusterIdentityList_To_v1alpha3_AzureClusterIdentityList(in *v1alpha4.AzureClusterIdentityList, out *AzureClusterIdentityList, s conversion.Scope) error {
	out.ListMeta = in.ListMeta
	out.Items = *(*[]AzureClusterIdentity)(unsafe.Pointer(&in.Items))
	return nil
}
...
// Convert_v1alpha3_AzureClusterIdentitySpec_To_v1alpha4_AzureClusterIdentitySpec is an autogenerated conversion function.
func Convert_v1alpha3_AzureClusterIdentitySpec_To_v1alpha4_AzureClusterIdentitySpec(in *AzureClusterIdentitySpec, out *v1alpha4.AzureClusterIdentitySpec, s conversion.Scope) error {
	return autoConvert_v1alpha3_AzureClusterIdentitySpec_To_v1alpha4_AzureClusterIdentitySpec(in, out, s)
}
...
// Convert_v1alpha4_AzureClusterIdentitySpec_To_v1alpha3_AzureClusterIdentitySpec is an autogenerated conversion function.
func Convert_v1alpha4_AzureClusterIdentitySpec_To_v1alpha3_AzureClusterIdentitySpec(in *v1alpha4.AzureClusterIdentitySpec, out *AzureClusterIdentitySpec, s conversion.Scope) error {
	return autoConvert_v1alpha4_AzureClusterIdentitySpec_To_v1alpha3_AzureClusterIdentitySpec(in, out, s)
}
...
func autoConvert_v1alpha3_AzureMachineSpec_To_v1alpha4_AzureMachineSpec(in *AzureMachineSpec, out *v1alpha4.AzureMachineSpec, s conversion.Scope) error {
	...
	out.Image = (*v1alpha4.Image)(unsafe.Pointer(in.Image))
...
// Convert_v1alpha4_AzureSharedGalleryImage_To_v1alpha3_AzureSharedGalleryImage is an autogenerated conversion function.
func Convert_v1alpha4_AzureSharedGalleryImage_To_v1alpha3_AzureSharedGalleryImage(in *v1alpha4.AzureSharedGalleryImage, out *AzureSharedGalleryImage, s conversion.Scope) error {
	return autoConvert_v1alpha4_AzureSharedGalleryImage_To_v1alpha3_AzureSharedGalleryImage(in, out, s)
}
...
func autoConvert_v1alpha3_Image_To_v1alpha4_Image(in *Image, out *v1alpha4.Image, s conversion.Scope) error {
	...
	out.SharedGallery = (*v1alpha4.AzureSharedGalleryImage)(unsafe.Pointer(in.SharedGallery))
...
func Convert_v1alpha4_LoadBalancerSpec_To_v1alpha3_LoadBalancerSpec(in *v1alpha4.LoadBalancerSpec, out *LoadBalancerSpec, s conversion.Scope) error {
